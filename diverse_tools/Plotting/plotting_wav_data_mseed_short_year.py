...
im = ax.pcolormesh(data_x_axis,cmap='magma', shading ='flat',ec='none')
...
ax.set_xticks(np.arange(data_x_axis.shape[1]) + 0.5, name_months)
ax.set_yticks(np.arange(data_x_axis.shape[0]) + 0.5, datetime_lista_years)
